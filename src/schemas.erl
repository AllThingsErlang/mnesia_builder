...
-export([build_and_validate_record/4, build_record/2, validate_record/3]).
...
create_schema(SchemaName)-> 
  ...
  S2 = maps:put(disc_copies, [], S1),
  S3 = maps:put(disc_only_copies, [], S2),
  S4 = maps:put(ram_copies, [], S3),
...
% Returns:  
%------------------------------------------------------------- 
update_schema_field_list(FieldList, SchemaName, SS) -> 
