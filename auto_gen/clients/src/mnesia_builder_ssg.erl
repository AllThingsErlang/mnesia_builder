...
get_ssg() ->
    #{name => mnesia_builder_ssg,owner => "All Things Erlang",
      version => "0.2",description => "SSG used by mnesia_builder",
      created => {{2025,1,8},{16,26,53}},
      email => "haitham@gmail.com",
      schemas =>
          [{ssg_table,#{name => ssg_table,type => bag,description => [],
                        fields => [],disc_copies => [],disc_only_copies => [],
                        ram_copies => ['blue@LAPTOP-6B8AG7F5']}}]}.
